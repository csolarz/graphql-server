...
// ResolverUsecase is an autogenerated mock type for the ResolverUsecase type
type ResolverUsecase struct {
	mock.Mock
}

// Installment provides a mock function with given fields: ctx, id
func (_m *ResolverUsecase) Installment(ctx context.Context, id int64) (*model.Installment, error) {
...
func (_m *ResolverUsecase) Loan(ctx context.Context, id int64) (*model.Loan, error) {
	ret := _m.Called(ctx, id)
...
func (_m *ResolverUsecase) User(ctx context.Context, id int64) (*model.User, error) {
	ret := _m.Called(ctx, id)
...
// NewResolverUsecase creates a new instance of ResolverUsecase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewResolverUsecase(t interface {
	mock.TestingT
	Cleanup(func())
}) *ResolverUsecase {
	mock := &ResolverUsecase{}
	mock.Mock.Test(t)
